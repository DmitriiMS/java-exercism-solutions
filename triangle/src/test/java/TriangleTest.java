...
public class TriangleTest {
    ...
    @Test
    public void firstDegenerateTriangle() throws TriangleException {
        Triangle triangle = new Triangle(1,1,2);
        assertTrue(triangle.isDegenerate());
    }

    @Test
    public void secondDegenerateTriangle() throws TriangleException {
        Triangle triangle = new Triangle(2,1,1);
        assertTrue(triangle.isDegenerate());
    }

    @Test
    public void thirdDegenerateTriangle() throws TriangleException {
        Triangle triangle = new Triangle(1,2,1);
        assertTrue(triangle.isDegenerate());
    }

    @Test
    public void scaleneNotDegenerate() throws TriangleException {
        Triangle triangle = new Triangle(5, 4, 6);
        assertFalse(triangle.isDegenerate());
    }

    @Test
    public void equilateralNotDegenerate() throws TriangleException {
        Triangle triangle = new Triangle(5, 5, 5);
        assertFalse(triangle.isDegenerate());
    }

    @Test
    public void isoscelesNotDegenerate() throws TriangleException {
        Triangle triangle = new Triangle(4, 3, 4);
        assertFalse(triangle.isDegenerate());
    }

    @Test
    public void verySmallTrianglesCanBeDegenerate() throws TriangleException {
        Triangle triangle = new Triangle(0.2, 0.4, 0.2);
        assertTrue(triangle.isDegenerate());
    }
}
